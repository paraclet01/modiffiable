...
namespace OPTICIP.Entities.DataEntities
{
    public class TErreurRetour : IAggregateRoot
    {
        ...
        public TErreurRetour(Guid P_Id, Guid P_EnregistrementID, string P_EnregistrementTable, string P_Numero_Ligne_Erreur, string P_Champ_Erreur, string P_Code_Erreur, string P_Libelle_Erreur)
        {
            Id = P_Id;
            ...
            Libelle_Erreur = P_Libelle_Erreur;
